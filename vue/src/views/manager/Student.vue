<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 10px;">
      <el-input style="width: 260px; " v-model="data.username" placeholder="请输入账号查询" prefix-icon="Search"></el-input>
      <el-input style="width: 260px; " v-model="data.name" placeholder="请输入名称查询" prefix-icon="Search"></el-input>
    ...
    <div class="card" style="margin-bottom: 10px">
      ...
      <el-table stripe :data="data.tableData" style="width: 100%;">
        ...
        <el-table-column prop="username" label="学生账号" width="120px; " />
        <el-table-column prop="name" label="学生姓名" width="120px; "/>
        ...
        <el-table-column prop="brithday" label="生日" width="120px; "/>
    ...
    <el-dialog title="学生信息" width="35%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" :rules="rules" ref="formRef" label-width="100px" label-position="right" style="padding-right: 40px">
        ...
        <el-form-item label="生日">
          <el-date-picker format="YYYY-MM-DD" value-format="YYYY-MM-DD" v-model="data.form.brithday"></el-date-picker>
        </el-form-item>
...
import {ref, reactive} from "vue";        // 引入两个内置函数     因为Vue3必须先引用，才能使用
